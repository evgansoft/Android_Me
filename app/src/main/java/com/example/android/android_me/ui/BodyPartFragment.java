...
//        imageView.setImageResource(AndroidImageAssets.getHeads().get(0));
        ...
        if (imageResources != null) {
            imageView.setImageResource(imageResources.get(itemToDisplay));
        }  else {
            Log.i(TAG, "Image resources isn't set.");
        }
    ...
    public void setImageResources(final List<Integer> imageResources) {
        this.imageResources = imageResources;
    }

    public void setItemToDisplay(final int itemToDisplay) {
