...
public class BodyPartFragment extends Fragment {
    ...
    private static final String PARAM_IMAGE_ID_LIST = "imageIdList";
    private static final String PARAM_LIST_INDEX = "listIndex";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(PARAM_IMAGE_ID_LIST);
            mListIndex = savedInstanceState.getInt(PARAM_LIST_INDEX);
        }
    ...
    public void onSaveInstanceState(final Bundle outState) {
        ...
        outState.putIntegerArrayList(PARAM_IMAGE_ID_LIST, new ArrayList<>(mImageIds));
        outState.putInt(PARAM_LIST_INDEX, mListIndex);
    }
}
